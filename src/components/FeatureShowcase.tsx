...
export default function FeatureShowcase() {
  ...
  return (
    <section className="border-b structural-border bg-[#fcfcfc]">
      {/* Full Bleed Break */}
      <div className="aspect-[16/9] md:aspect-[21/9] w-full bg-white border-b structural-border relative overflow-hidden flex items-center justify-center">
        <div className="text-black/40 font-mono text-sm tracking-widest uppercase">
      ...
      <div className="py-24 md:py-40 px-6 md:px-12 max-w-7xl mx-auto space-y-32">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-display font-medium text-black leading-tight">
          ...
          >
            <div className="aspect-[4/3] bg-white border structural-border rounded-xl flex items-center justify-center text-black/40 font-mono shadow-sm">
